...
public unsafe struct cef_life_span_handler_t
{
    ...
    /// additional details.
    ///
    public delegate* unmanaged<cef_life_span_handler_t*, cef_browser_t*, cef_frame_t*, int, cef_string_t*, cef_string_t*, cef_window_open_disposition_t,
        int, cef_popup_features_t*, cef_window_info_t*, cef_client_t**, cef_browser_settings_t*, cef_dictionary_value_t**, int*, int> on_before_popup;
    ...
    ///
    public delegate* unmanaged<cef_life_span_handler_t*, cef_browser_t*, int, void> on_before_popup_aborted;
    ...
    ///
    public delegate* unmanaged<cef_life_span_handler_t*, cef_browser_t*, cef_window_info_t*, cef_client_t**, cef_browser_settings_t*, cef_dictionary_value_t**, int*, void> on_before_dev_tools_popup;
    ...
    ///
    public delegate* unmanaged<cef_life_span_handler_t*, cef_browser_t*, void> on_after_created;
    ...
    ///     exist.
    ///
    public delegate* unmanaged<cef_life_span_handler_t*, cef_browser_t*, int> do_close;
    ...
    ///
    public delegate* unmanaged<cef_life_span_handler_t*, cef_browser_t*, void> on_before_close;
}
...
///
[StructLayout(LayoutKind.Sequential)]
public unsafe struct cef_popup_features_t
{
    public cef_popup_features_t()
    {
        size = (nuint)sizeof(cef_popup_features_t);
    }
